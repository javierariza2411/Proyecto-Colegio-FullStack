...
import com.colegio.administrador.util.ErrorDetails;
import com.colegio.administrador.util.FieldErrorValidation;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ColegioAPIException.class)
    public ResponseEntity<ErrorDetails> handlerBrasiliaAPIException(ColegioAPIException ex, WebRequest webRequest) {
        ErrorDetails errorDetails = new ErrorDetails(new Date(), ex.getMessage(), webRequest.getDescription(false));
